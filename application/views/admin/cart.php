			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="row">
						<div class="content">
							<div class="container">
								<form method="post" action="<?php echo base_url('admin/cart'); ?>" enctype="multipart/form-data">
                                <div class="input-group input-search">
										<label >ID Pesanan</label><br/>
										<input style="width:300px;" type="text" readonly="" value="PSN-<?= base_convert(microtime(false), 36, 10); ?>" class="form-control name="q" id="q" name="idpesanan">
									</div>
                                    <div class="input-group input-search">
										<label >Nama Menu</label><br/>
                                        <select style="width:350px;" name="idmenu" class="form-control" id="">
                                            <option value="">Pilih Menu</option>
                                            <?php foreach($menu as $dap) : ?>
                                            <option value="<?= $dap['idmenu']; ?>"><?= $dap['namamenu']; ?></option>
                                        <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="input-group input-search">
										<label >Nama Pelanggan</label><br/>
                                        <select style="width:350px;" name="idpelanggan" class="form-control" id="">
                                            <option value="">Pilih Pelanggan</option>
                                            <?php foreach($pelanggan as $da) : ?>
									...
									<div class="input-group input-search">
                                        ...
                                        <input type="number" class="form-control" name="jumlah" style="width:200px;">
									</div>
									<br>
									<div class="input-group input-search">
										<label >ID User</label><br>
										<input style="width:300px;" readonly="" value="<?= $this->session->userdata('nama'); ?>" type="text" class="form-control" name="iduser">
									</div>
									<br>
									<div class="input-group input-search">
										<input type="text" hidden="" name="status_pesanan" value="Belum dibayar">
									</div>
									<br>
									<div class="input-group input-search">
