						...
						<div class="content">
							<div class="container">
								<table class="table table-hover" border="1">
									...
									<?php foreach($makanan as $no => $data) : ?>
										<tr>
										<td><?php echo $no+1; ?></td>
										<td><?php echo $data['idmenu']; ?></td>
										<td><?php echo $data['namamenu']; ?></td>
										<td><?php echo $data['harga']; ?></td>
										<td><img width="60" src="<?php echo base_url()?>/img/<?php echo $data['gambar']; ?>"></td>
										<td><?php echo $data['desk']; ?></td>
										<td><a onclick="return confirm('Yakin Ingin Dihapus ? ')" href="<?php echo base_url('admin/deletemenu'); ?>/?id=<?php echo $data['idmenu']; ?>">Hapus</a></td>
										</tr>
									<?php endforeach; ?>
								</table>
						</div>
