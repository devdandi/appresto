			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="row">
						<div class="content">
							<div class="container">
								<h2>Selamat Datang <?= $this->session->userdata('level'); ?></h2>
								<h5><b>Nama Lengkap : <?= $this->session->userdata('nama'); ?></b></h5>	
								<b>Hari & Tanggal : <?= date('l, m F Y'); ?></b>
								...
								<p>Jam : <b style="font-size: 12px; font-family: verdana;" id="jam"></b> <?= date('a'); ?></p>
					...
					<div class="row">
						<div class="container">
							<h2>Print Data</h2>
							<br>
							<form method="get" action="<?php echo base_url('reportpdf/index'); ?>">
								<div class="input-group input-search">
									<label>Dari tanggal</label><br/>
									<input style="position: relative; width:200px;" type="date" name="dari_tanggal"  class="form-control">
								</div>
								<div class="input-group input-search">
									<label>Sampai tanggal</label><br/>
									<input style="position: relative; width: 200px;" type="date" name="sampai_tanggal"  class="form-control">
								</div>
								<div class="input-group input-search">
									<input style="position: relative; top: 50px;" type="submit" name="submit" class="btn btn-primary">
								</div>
							</form>
						</div>
					</div>
