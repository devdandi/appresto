			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="row">
						<div class="content">
							<div class="container">
								<form method="post" action="<?php echo base_url('admin/register'); ?>" enctype="multipart/form-data">
									<div class="input-group input-search">
										<label >ID User</label>
										<input type="text" readonly="" value="<?php  echo base_convert(microtime(false), 36, 10); ?>" class="form-control name="q" id="q"" name="id">
									</div>
									<br>
									<div class="input-group input-search">
										<label >Nama</label>
										<input type="text" class="form-control name="q" id="q" name="nama">
									</div>
									<br>
									<div class="input-group input-search">
