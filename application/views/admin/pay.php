				...
				<section role="main" class="content-body">
					...
					<div class="row">
							<div class="container">
								...
								<p>-------------------------------------------------------------------------------</p>
								<p>Detail pembelian & struk</p>
								<p>-------------------------------------------------------------------------------</p>
								<br>
								<?php foreach($vtransaksi as $data) : ?>
									<?php if($data['bayar'] >= $data['total']){ ?>
									<p><b>Nama Pelanggan : <?php echo $data['namapelanggan']; ?></b></p>
									<p><b>ID Pesanan : <?php echo $data['idpesanan']; ?></b></p>
									<p><b>Alamat : <?php echo $data['alamat']; ?></b></p>
									<p><b>Jumlah Beli : <?php echo $data['jumlah']; ?></b></p>
									<p><b>Total : Rp. <?php echo number_format($data['total']); ?></b></p>
									<p><b>Bayar : Rp. <?php echo number_format ($data['bayar']); ?></b></p>
									<p><b>Tanggal Pembelian : <?php echo $data['tanggal']; ?></b></p>
									<p><b>-------------------</b></p>
									<p><b>Nama Kasir : <?php echo $this->session->userdata('nama'); ?></b></p>
									<p><b>-------------------</b></p>
									<p>-------------------------------------------------------------------------------</p>
									<p><b>Uang Kembali : Rp. <?php echo number_format ($data['bayar'] - $data['total']); ?></b></p>
									<p>-------------------------------------------------------------------------------</p>
								<a href="<?php echo base_url('admin/entrytransaksi') ?>">Kembali</a>
								<?php }else{ ?>
										<h3>Pembayaran Gagal</h3>
										<h5>Uang tidak cukup</h5>
								<?php } ?>
								<?php endforeach; ?>
