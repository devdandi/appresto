			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					...
					<div class="row">
						<div class="content">
							<div class="container">
								<form method="post" action="<?php echo base_url('admin/entrybarang'); ?>" enctype="multipart/form-data">
									<div class="input-group input-search">
										<label >ID Makanan</label>
										<input type="text" readonly="" value="<?php echo base_convert(microtime(false), 10, 36); ?>" class="form-control name="q" id="q"" name="idmakanan">
									</div>
									<br>
									<div class="input-group input-search">
										<label >Nama Makanan</label>
										<input autocomplete="off" type="text" class="form-control name="q" id="q"" name="namamakanan">
									</div>
									<br>
									<div class="input-group input-search">
										<label >Harga</label>
										<input autocomplete="off" type="number" class="form-control name="q" id="q"" name="harga">
									</div>
									<br>
									<div class="input-group input-search">
									...
									<br>
									<div class="input-group input-search">
										<input type="submit" name="submit" class="btn btn-primary" value="Simpan Data" class="form-control">
									</div>
								</form>
							</div>
						</div>
