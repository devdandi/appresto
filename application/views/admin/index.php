				...
				<div class="header-right">
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							...
							<div class="profile-info" data-lock-name="<?php echo $this->session->userdata('nama'); ?>" data-lock-email="<?php echo $this->session->userdata('username'); ?>">
								...
								<ul class="nav nav-main">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											...
											<li>
												<a href="<?php echo base_url() ?>admin/datamenu">
													 Data Menu
												</a>
											</li>
											<?php } ?>
