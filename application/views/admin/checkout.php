					...
					<div class="row">
							<div class="container">
								<h2>Checkout</h2>
									...
									<table class="table table-hover" border="1">
										...
										<?php foreach($cart as $data) : ?>
											<tr>
												...
												<td>Rp. <?php echo number_format($hasil = $data['harga'] * $data['jumlah']); ?></td>	
											</tr>
											<?php $sub2 = $subtotal+=$hasil; ?>	
										 <?php endforeach; ?>  
									...
									<form method="post" action="<?php echo base_url('admin/pay'); ?>/?idpelanggan=<?php echo $_GET['id']; ?>" >
										<div class="input-group input-search">
											<label>ID Transaksi</label><br/>
											<input readonly="" type="text" class="form-control" style="width:300px;" name="idtransaksi" value="TSR-<?php echo base_convert(microtime(false), 36, 10); ?>">
										</div>
										<div class="input-group input-search">
											<label>ID Pesanan</label><br/>
											<input readonly="" type="text" class="form-control" style="width:300px;" name="idpesanan" value="<?php echo $_GET['idpesanan']; ?>">
										</div>
										<div class="input-group input-search">
											<label>Total</label><br/>
											<input readonly="" type="text" class="form-control" name="total" style="width:200px;" value="<?php echo $sub2; ?> ">
											<input type="text" value="<?php echo date('Y-d-m'); ?>" name="tanggal" hidden="" > 
										</div>
										<div class="input-group input-search">
											<label>Bayar</label><br/>
											<input  type="text" class="form-control" style="width:300px;" name="bayar" >
										</div>
										<br>
										<div class="input-group input-search">
