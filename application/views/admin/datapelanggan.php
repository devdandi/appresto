				...
				<section role="main" class="content-body">
					...
					<br>
					    ...
					    <table class="table table-hover" border="1">
							...
							<?php foreach($datapelanggan as $no => $hasil) : ?>
								<tr>
									<td><?php echo $no+1; ?></td>
									<td><?php echo $hasil['idpelanggan']; ?></td>
									<td><?php echo $hasil['namapelanggan']; ?></td>
									<td><?php echo $hasil['namamenu']; ?></td>
									<td><?php echo $hasil['jumlah']; ?></td>
									<td><?php echo $hasil['total']; ?></td>
									<td><?php echo $hasil['bayar']; ?></td>
									<td><?php echo $hasil['tanggal']; ?></td>
									<td><a onclick="return confirm('Yakin hapus ?')" href="<?php echo base_url('admin/hapuspelanggan') ?>">
										Hapus
									</a></td>
								</tr>
							<?php endforeach; ?>
						</table>
						<a onclick="return confirm('Hapus Semua Data ?')" href="<?php echo base_url('admin/hapussemua') ?>">
							Hapus Semua
						</a>
					</div>
				</div>
